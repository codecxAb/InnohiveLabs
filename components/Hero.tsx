...
import { ArrowRight, Code, Palette, Zap, Search, Smartphone, Database } from 'lucide-react'
...
export default function Hero() {
  ...
  return (
    <section ref={heroRef} className="relative flex items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8 opacity-0 overflow-hidden">
      ...
      <div className="text-center max-w-5xl z-10">
        ...
        <p className="text-gray-400 text-xl mb-8">
          We craft innovative web solutions that drive growth and transform businesses. 
          From stunning designs to powerful functionality, we bring your digital vision to life.
        </p>
